...
namespace XunitContrib.Runner.ReSharper.Tests.AcceptanceTests
{
    ...
    {
      protected override void ExploreAssembly(IProject testProject, IMetadataAssembly metadataAssembly, IUnitTestElementsObserver observer)
        {
            GetMetdataExplorer().ExploreAssembly(testProject, metadataAssembly, observer);
        }
